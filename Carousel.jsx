  ...
  return (
    <Box
      sx={{
        ...
        width: "90%", // Set a reduced width (90% of the parent)
        margin: "0 auto", // Center the carousel
        paddingBottom: { xs: "56.25%", md: "42.86%" }, // 16:9 for small screens, 21:9 for medium and larger
      }}
    >
      <Box
        sx={{
          ...
          height: 0, // Added height to ensure the Box occupies space
        }}
      >
        {images.map((image, index) => (
          <Box
            ...
            sx={{
              minWidth: "100%",
              height: 0,
              paddingBottom: "100%", // Ensure it occupies the space correctly
